...
public class SpaceBiomes {
    public static final ResourceKey<Biome> HARANDRA = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(MLPlanets.MODID,"harandra"));

    public static void bootstrap(BootstapContext<Biome> context) {
        context.register(HARANDRA, harandra(context));
    }
    ...
    private static Biome harandra(BootstapContext<Biome> context) {
